...
<body>
	...
	<label>아이디</label><input type="text" name="uId" id="uId" value="<%=(recv.getuId()==null)?"":recv.getuId()%>"><input type="button" value="중복확인" onClick="idCheck()"></button><%if(gbn ==null){out.println(" 중복되었습니다.");}else{out.println("");}%><br>
	...
	<input type="submit" value="媛���"><button><a href="index.jsp">가입</a></button> 
